...
public class Registry {
	...
	public TrafficLight find(String id) {
	...
	public ArrayList<TrafficLight> findPrev(String id){
	...
	public ArrayList<TrafficLight> findNext(String id){
	...
	public void create(String id, int type, String street, int streetNumber) {
		
		TrafficLight newTrafficLight;
		if(type == 0) {
			newTrafficLight = new PedestrianTrafficLight(id, 0, street, streetNumber);
		} else if(type == 1) {
			newTrafficLight = new ThreeColorTrafficLight(id, 1, street, streetNumber);
		} else if(type == 2) {
			newTrafficLight = new SingleColorTrafficLight(id, 2, street, streetNumber);
		} else if(type == 3) {
			newTrafficLight = new BicycleTrafficLight(id, 3, street, streetNumber);
		}
	...
	public void changeType(String id, int newType) {
		
		TrafficLight currentTrafficLight = this.find(id);
		TrafficLight newTrafficLight;
		
		if(newType == 0) {
			newTrafficLight = new PedestrianTrafficLight(currentTrafficLight.getId, 0, currentTrafficLight.getStreet, currentTrafficLight.getStreetNumber);
		} else if(newType == 1) {
			newTrafficLight = new ThreeColorTrafficLight(currentTrafficLight.getId, 1, currentTrafficLight.getStreet, currentTrafficLight.getStreetNumber);
		} else if(newType == 2) {
			newTrafficLight = new SingleColorTrafficLight(currentTrafficLight.getId, 2, currentTrafficLight.getStreet, currentTrafficLight.getStreetNumber);
		} else if(newType == 3) {
			newTrafficLight = new BicycleTrafficLight(currentTrafficLight.getId, 3, currentTrafficLight.getStreet, currentTrafficLight.getStreetNumber);
		}
